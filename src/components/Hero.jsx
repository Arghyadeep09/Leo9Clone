...
const clientLogos = [
  "./src/assets/tata.webp",
  "./src/assets/bmw-svgrepo-com.svg",
  "./src/assets/sony-2-logo-svgrepo-com.svg",
  "./src/assets/huggies.svg",
  "./src/assets/Eton-Logo.webp",
  "./src/assets/procter-gamble-1.svg",
];
    ...
    <section className="relative w-full h-screen bg-white text-black flex flex-col justify-between mt-2">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between w-full px-6 lg:px-20 h-[90%]">
        ...
        <div className="w-full lg:w-1/2 flex justify-center items-center">
          <motion.img
            src="./src/assets/lion-face-svgrepo-com.svg"
            alt="Animation"
